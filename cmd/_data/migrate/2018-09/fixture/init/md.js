...
Failed waterproofing, rusted rebar and concrete spalling eventually derailed my whole life. In 2017 I invested more time into creative non-confrontational **Strata dispute resolution** attempts than it took to launch and raise $2M venture funding for my most recent and heavily suffering Startup. In 2018 I deep-dived full-time into **Strata caselaw** research and meeting **Strata lawyers** only to find **NSW Strata litigation** landscape in period of uncertainty and flux. Luckily entrepreneurs are used to finding opportunity where others see only anarchy and the greatest insights and innovation often incubate during the most painful personal experiences.
...
let mdDir = join(__dirname,'./../../../../../../tmpl/md')
